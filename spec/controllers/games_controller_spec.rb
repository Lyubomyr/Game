  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "details_id" => "invalid value" }}, valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update_attributes).with({ "details_id" => "1" })
        put :update, {:id => game.to_param, :game => { "details_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Game.any_instance.stub(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "details_id" => "invalid value" }}, valid_session
        assigns(:game).should eq(game)
      end
